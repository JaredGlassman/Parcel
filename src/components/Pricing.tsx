...
const tiers = [
  {
    ...
    blurb: "One zip cluster, one industry. Perfect for owner-operators testing the channel.",
    features: [
  ...
  },
  {
    ...
    cadence: "/mo",
    plan: "metro" as const,
    blurb: "Full metro coverage with priority scoring. Most popular for growing teams.",
    features: [
  ...
  },
  {
    ...
    cadence: "",
    plan: null,
    blurb: "Multiple metros, custom verticals, and exclusivity windows for established operators.",
    features: [
      "Unlimited leads",
...
export default function Pricing() {
  const [modal, setModal] = useState<"starter" | "metro" | null>(null);
        ...
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-balance text-lg text-ink-500">
              One flat monthly rate per territory. No per-lead fees, no long contracts.
            </p>
          </div>
            ...
            {tiers.map((t, i) => (
              ...
              >
                ...
                <div className="mt-4 flex items-baseline gap-1">
                  <span className={`text-5xl font-semibold tracking-[-0.04em] ${t.highlight ? "gradient-text" : "text-ink-900"}`}>
                    {t.price}
                  </span>
                ...
                {t.plan ? (
                  ...
                  <a
                    ...
                    className="group mt-8 inline-flex w-full items-center justify-center gap-2 rounded-full border border-ink-200 bg-white px-4 py-3 text-sm font-medium text-ink-900 transition hover:border-ink-300"
                  >
                    {t.cta}
                    <ArrowRight size={14} strokeWidth={2.5} className="transition group-hover:translate-x-0.5" />
                  </a>
